...
public class ObjectPlusPlus extends model.ObjectPlus implements Serializable {
    ...
    public boolean isLink(String roleName, ObjectPlusPlus targetObject) { // sprawdzenie przy ograniczeniu subset
